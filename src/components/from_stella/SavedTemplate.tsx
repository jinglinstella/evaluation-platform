...
function Header({updateParentTitle, header, style}: any){
  ...
  const [description, setDescription] = useState('添加段落文字...');
            ...
            <div className={styles.editContainer}>
                ...
                <Stack direction="column" sx={{
                    ...
                    <div className={`${styles[`student1Edit-${sheetType}`]}`}>
                        <h1 className={styles.studentTitle1Edit}>基本信息</h1>
                    </div>
                ...
                <div className={styles.basicInfoBg} >
                    <div className={`${styles[`student1-${sheetType}`]}`}>
                        <div style={{display:'flex'}}>
                            ...
                            <div>
                                <h1 className={styles.studentTitle1}>基本信息</h1>
                            </div>
                        </div>
                    </div>
...
function SavedTemplate({id, type}: any) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            console.log("Scoresheet ID: ", scoresheetId); 
            console.log("Scoresheet Type: ", scoresheetType); 
            try {
                ...
                const target = data.message.find((m: any) => m.uuid === `${scoresheetId}`);
    ...
    return (
      <main className={styles.main}>
        <div className={styles.wrapper}>
            <h1 className={styles.title0}>创建新课堂教学评估表</h1>
