...
export default function Level1MetricPieChart({ chart, totalSectionScore, maxSectionScore, sectionIndex,...other }: Props) {
    ...
    plotOptions: {
      radialBar: {
        ...
        dataLabels: {
          ...
          total: {
            label: `${Math.round(totalSectionScore)}/${maxSectionScore}`,
